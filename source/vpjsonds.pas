...
function TVpJSONDataStore.GetNextID(TableName: string): Int64;
begin
  Unused(TableName);
  (*
  if FUseAutoInc then
...
function TVpJSONDataStore.JSONToEvent(AObj: TJSONObject; AResource: TVpResource
  ): TVpEvent;
var
  evID: Integer;
...
function TVpJSONDataStore.JSONToTask(AObj: TJSONObject; AResource: TVpResource
  ): TVpTask;
var
  recID: Integer;
  s: String;
